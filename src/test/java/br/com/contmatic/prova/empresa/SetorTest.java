...
public class SetorTest {
    ...
    void nao_deve_aceitar_caracter_numerico_especial_nome(String nomeErrado) {
        ...
        assertTrue(
            this.illegalState.getMessage().contains("Quantidade de carácter inválido, o campo deve estar entre " + br.com.contmatic.prova.constantes.model.SetorConstantes.TAMANHO_MINIMO_NOME_SETOR +
                " a " + br.com.contmatic.prova.constantes.model.SetorConstantes.TAMANHO_MAXIMO_NOME_SETOR + " caracteres" + ", atualmente o campo possui " + nomeErrado.length()));
    }
    ...
    void nao_deve_aceitar_caracter_numerico_especial_descricao(String nomeErrado) {
        ...
        assertTrue(
            this.illegalState.getMessage().contains("Quantidade de carácter inválido, o campo deve estar entre " + br.com.contmatic.prova.constantes.model.SetorConstantes.TAMANHO_MINIMO_DESCRICAO +
                " a " + br.com.contmatic.prova.constantes.model.SetorConstantes.TAMANHO_MAXIMO_DESCRICAO + " caracteres" + ", atualmente o campo possui " + nomeErrado.length()));
    }
    ...
    void deve_validar_equals_hashcode() {
        assertAll(() -> assertEquals(setorCompleto, setorCompleto), () -> assertNotEquals(null, setorCompleto), () -> assertNotEquals(setor, setorCompleto),
            () -> assertNotEquals(true, setorCompleto.equals(new Object())));
    }

    @Test
    void deve_validar_toString() {
        assertAll(() -> assertThat(setorCompleto.toString(), containsString(setorCompleto.getNome())), () -> assertThat(setorCompleto.toString(), containsString(setorCompleto.getDescricao())));
    }
